...
/**
 *https://youtu.be/vV6ENkfLo1s?list=PLJIP7GdByOyuBKB--fIO2DoQaPVXm9lCw&t=511
 * @author maycon
 */

//Esta clesse simula as tabelas do banco:
public class Banco {
    ...
    public static void inicia(){
        ...
        Usuario usuario1 = new Usuario(1, "maycon", 'M', "09/05/1996", "30212121", "barbeiro@barbershop.com", "521454123", "123456", "administrador");
        ...
        Usuario usuario3 = new Usuario(3, "admin", 'M', "09/05/1996", "30212121", "barbeiro@barbershop.com", "521454123", "123", "administrador");
         
        Cliente cliente1 = new Cliente(1, "Maycon", 'M', "30/01/1995", "30212126", "mayconjr09@hotmail.com", "5142487", "Rua jaboti 35 Canudos NH",  "93300012");
        Cliente cliente2 = new Cliente(2, "Leticia", 'F', "30/08/1994", "30212127", "leticianekomf@gmail.com", "5142487745", "Rua campo bom 78 Centro NH",  "93300045");
